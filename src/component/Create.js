      ...
      <div className="w-full max-w-md mx-auto rounded-lg">
        <div className="bg-white p-4 rounded-lg shadow-md">
          ...
          <input
            ...
            name="title"
            placeholder="Title"
            className="w-full p-2 mb-3 bg-indigo-200 border rounded border-gray-300 rounded-xl"
          ...
          <textarea
            ...
            style={{height:'40vh'}}
            className="w-full bg-indigo-200  p-2 mb-3 border rounded border-gray-300 rounded-xl"
            onChange={handleInputChange}
          />
          <div className="flex h-10 bg-indigo-200 items-center justify-between mb-3 rounded-xl">
            ...
            <div className="bg-indigo-600 w-1/3 text-sm text-white px-3 h-full py-1 rounded-tr-xl rounded-br-xl">Change</div>
          </div>
          <div className="flex items-center flex bg-indigo-200 h-10 justify-between mb-3 rounded-xl">
            ...
            <label htmlFor="image-input" className="cursor-pointer flex justify-between h-full w-full">
              ...
              <div className="bg-indigo-600 w-1/3 text-sm text-white px-3 h-full py-1 rounded-tr-xl rounded-br-xl">
                Add Image
              </div>
            </label>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div onClick={handleClose} className="h-12 w-full text-black px-3 py-1 rounded-lg cursor-pointer">
              Cancel
            </div>
            <div
              className="bg-indigo-600 h-12 w-full text-white px-3 py-1 rounded-lg cursor-pointer"
              onClick={handleSave}
            >
              Save
            </div>
